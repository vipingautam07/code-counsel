...
const OffcanvasExample = () => {
  return (
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full h-full bg-white text-sm py-4 sm:py-0 dark:bg-gray-800">
  <nav
  ...
  >
    <div className="relative sm:flex sm:items-center">
      <div className="flex items-center justify-between">
        <a className="flex-none text-2xl font-semibold dark:text-white" href="#">
          Code Counsel
        </a>
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] sm:border duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-auto hidden z-20 sm:mt-3 top-full min-w-[15rem] sm:shadow-md rounded-lg py-2 sm:px-2 bg-gray-800 sm:dark:border border-gray-700 divide-gray-700">
              <div className="sm:grid sm:grid-col-1">
                <div className="flex flex-col">
                  <a
                    className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="#"
                  >
                    Legal Resesarch
                  </a>
          ...
          <div className="hs-dropdown [--strategy:static] sm:[--strategy:absolute] [--adaptive:none] sm:[--trigger:hover]">
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] sm:border duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-auto hidden z-10 sm:mt-3 top-full min-w-[15rem] sm:shadow-md rounded-lg py-2 sm:px-2 bg-gray-800 sm:dark:border border-gray-700 divide-gray-700 before:absolute">
              <div className="sm:grid sm:grid-col-1">
                <div className="flex flex-col">
                  <a
                    className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none darfocus:ring-1 darfocus:ring-gray-600"
                    href="#"
                  >
      ...
      <button
          type="submit"
          className="group mt-6 mr-6 flex w-full whitespace-nowrap ml-5 items-center justify-center gap-2 rounded-md bg-teal-600 px-5 py-3 text-white transition focus:outline-none focus:ring focus:ring-teal-400 sm:mt-0 hover:bg-teal-900 sm:w-auto sm:mr-10 btn-1"
        >
